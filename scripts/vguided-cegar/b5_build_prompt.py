...
def build_prompt(benchmark_path, summary_dir):
    ...
    sections.append("**Task:** Generate **abstraction predicates** (Boolean features for precision tracking)\n")
    sections.append("that would help CPAchecker rule out these spurious traces and prove the assertion.\n\n")
