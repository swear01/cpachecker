...
4. **#109/#200 factual context:** #206 is closed/accepted model-free
   qualification on four original fixtures with 8/8 offline empty-response
   requests and exact trigger/context/accounting evidence. It does not qualify
   live model, predicate or solve quality. Keep #200's context A/B separate
   from the frozen checkpoint. #183's null wording experiment is complete; its
   cue is not adopted.
5. **#92 diagnostic cohort:** the original-symbol fix is complete, but the six
...
- **Completed #105 replication:** six foreground cached runs had zero provider
  calls; full-response and Stock were TRUE 3/3. This is whole-augmentation
  versus legal Stock evidence, not isolated candidate causality or a speedup/
  population claim. The broader ablation remains open.
